...
ggplot(time_perf.dt, aes(x = Time, y = R2, color = Method)) + geom_point() + ylab("R2") + xlab("Time (sec)") + 
...
param_number = 14
colnames(regressors)[param_number]
